...
type IncidentSubscription struct {
	...
	Runbooks           []types.String `tfsdk:"runbooks"`
}
...
type IncidentsConfig struct {
	DegradedArgocdApps    types.Bool               `tfsdk:"degraded_argocd_apps"`
	DegradedK8SNamespaces types.Bool               `tfsdk:"degraded_k8s_namespaces"`
	Subscriptions         []*IncidentSubscription  `tfsdk:"subscriptions"`
...
type InstanceSpec struct {
	...
	AppReconciliationsRateLimiting  *AppReconciliationsRateLimiting `tfsdk:"app_reconciliations_rate_limiting"`
}
