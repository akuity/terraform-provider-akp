		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.akp_kargo_instance.test-instance", "name", "test_instance"),
					// spec
					...
					resource.TestCheckResourceAttr("data.akp_kargo_instance.test-instance", "kargo_instance_spec.agent_customization_defaults.auto_upgrade_disabled", "true"),
					// cm
