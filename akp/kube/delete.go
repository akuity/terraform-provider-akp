...
func (k *Kubectl) newDeleteOptions(ioStreams genericclioptions.IOStreams, _ *unstructured.Unstructured, path string, deleteOpts DeleteOpts) (*delete.DeleteOptions, error) {
