...
func (r *AkpKargoAgentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err := r.clearDefaultShardAgentIfNeeded(ctx, &plan); err != nil {
...
func (r *AkpKargoAgentResource) upsert(ctx context.Context, diagnostics *diag.Diagnostics, plan *types.KargoAgent, isCreate bool) (*types.KargoAgent, error) {
	...
	if err := r.autoSetDefaultShardAgent(ctx, result, workspace.Id); err != nil {
...
func (r *AkpKargoAgentResource) autoSetDefaultShardAgent(ctx context.Context, agent *types.KargoAgent, workspaceID string) error {
...
func (r *AkpKargoAgentResource) clearDefaultShardAgentIfNeeded(ctx context.Context, agent *types.KargoAgent) error {
