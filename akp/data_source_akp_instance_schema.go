...
func getInstanceSpecDataSourceAttributes() map[string]schema.Attribute {
	return map[string]schema.Attribute{
		...
		"prefer_control_plane_repo_server": schema.BoolAttribute{
			MarkdownDescription: "When enabled, manifests for any repository used by an in-cluster application are generated by the control plane Repo Server instead of a managed cluster Repo Server. Mutually exclusive with `repo_server_delegate`.",
			Computed:            true,
		},
