...
- `managed_cluster_config` (Attributes) The ability to use a separate kubeconfig to access the managed cluster. (see [below for nested schema](#nestedatt--clusters--spec--data--managed_cluster_config))
